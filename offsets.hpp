...
namespace offsets {
    ...
    inline constexpr uintptr_t CanCollide = 0x24D;
    inline constexpr uintptr_t CanCollideMask = 0x8;
    inline constexpr uintptr_t CanTouch = 0x24D;
    ...
    inline constexpr uintptr_t DataModelDeleterPointer = 0x78A24D0;
    ...
    inline constexpr uintptr_t Gravity = 0x980;
    ...
    inline constexpr uintptr_t HumanoidState = 0x888;
    ...
    inline constexpr uintptr_t JobId = 0x18;
    inline constexpr uintptr_t JobStart = 0x1D0;
    inline constexpr uintptr_t Job_Name = 0x18;
    inline constexpr uintptr_t JobsPointer = 0x79E1868;
    ...
    inline constexpr uintptr_t MouseSensitivity = 0x7979D10;
    ...
    inline constexpr uintptr_t PlayerConfigurerPointer = 0x78802A8;
    inline constexpr uintptr_t PlayerMouse = 0x410;
    ...
    inline constexpr uintptr_t PrimitivesPointer2 = 0x0;
    ...
    inline constexpr uintptr_t ProximityPromptMaxActivationDistance = 0x100;
    ...
    inline constexpr uintptr_t RequireBypass = 0x938;
    ...
    inline constexpr uintptr_t TaskSchedulerPointer = 0x7065E7C;
    inline constexpr uintptr_t Team = 0x2954D;
    inline constexpr uintptr_t TeamColor = 0xD0;
    inline constexpr uintptr_t TextLabelText = 0x410;
    inline constexpr uintptr_t TextLabelVisible = 0x410;
    inline constexpr uintptr_t Tool_Grip_Position = 0x410;
    ...
    inline constexpr uintptr_t ViewportSize = 0x6AD28F;
